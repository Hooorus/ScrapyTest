    ...
    def parse(self, response, **kwargs):
        ...
        try:
            ...
            for first_link_element in first_link_elements:
                ...
                # issue_title
                issue_title = first_link_meta_element.find_element(By.XPATH, "./div[@class='dtl-wrap']/div[@class='dtl-top']/h1").text
                # issue_desc
                issue_desc = first_link_meta_element.find_element(By.XPATH, "./div[@class='dtl-wrap']//div[@class='atcle-ms']/p").text
                # issue_date
                issue_date = first_link_meta_element.find_element(By.XPATH, "./div[@class='dtl-top']//div[@class='dtl-info']/span").text
                # answer_doctor
                answer_doctor = (first_link_meta_element.find_element(By.XPATH, "//dl[@class='dtl-ys']/dd/b").text +
                                 first_link_meta_element.find_element(By.XPATH, "//dl[@class='dtl-ys']/dd/p")).text
                # answer_analyze
                ...
                # answer_date
                answer_date = first_link_meta_element.find_element(By.XPATH, "//div[@class='dtl-time']/div[@class='dtl-issue']/span").text
